...
t:option(DummyValue, "ghs5s", translate("GH/S(5s)"))
t:option(DummyValue, "ghsav", translate("GH/S(avg)"))
...
t2:option(DummyValue, "diff", translate("Diff"))
t2:option(DummyValue, "diff1shares", translate("Diff1#"))
...
t2:option(DummyValue, "lastsharedifficulty", translate("LSDiff"))
t2:option(DummyValue, "lastsharetime", translate("LSTime"))
